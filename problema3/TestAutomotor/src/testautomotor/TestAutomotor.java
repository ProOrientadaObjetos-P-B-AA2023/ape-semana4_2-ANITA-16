...
class Automotor{
    ...
    public Automotor(String cedulaPropietario, Fabricante fabricante, int anioFafricacion, double valorVehiculo) {
...
public class TestAutomotor {
    ...
    public static void main(String[] args) {
        ...
        Automotor automotor1 = new Automotor("1105678910", fabricante1,2015,25000);
